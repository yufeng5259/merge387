import { _decorator, CCBoolean, CCString, Enum, Component } from 'cc';
...
export class TLoadBuilding extends Component {
...
//                //设置云朵
        ...
        // }
//                //设置lv
        // uuid = Editor.assetdb.remote.urlToUuid(`db://assets/LiveData/COMICZ.TTF`)
        // if (uuid) {
        // allResNum++;
...
//     private buildMaxLevel = 5
// 
//     @property({ type: cc.String,tooltip:"动画文件名称,后续在完善目前没有需求" })
