...
export class TReBuild extends Component {
    ...
    private load_Build() {
        ...
        // const prefabUrl = "db://assets/resources/res/village/buildPrefabs/z0/0.prefab";
        // const uuid = Editor.assetdb.remote.urlToUuid(prefabUrl);

        // if (!uuid) {
        // Editor.log(`[TReBuild] common prefab uuid not found, url=${prefabUrl}`);
        ...
        // if (err || !prefab) {
        // Editor.log(`[TReBuild] load common prefab fail, err=${err}`);
        // Editor.log(`load:over total=0`);
        // res();
        // return;
        // }
        ...
        // const loader: any = nd.getComponent("LoadElementNode");
        // if (loader && loader.setupBuildId) {
        // setupPromises.push(loader.setupBuildId(index).catch((setupErr) => {
        // Editor.log(`[TReBuild] setup build fail, index=${index}, err=${setupErr}`);
        // }));
        // }
        ...
        // Editor.log(`load:over total=${keys.length}`);
        // res();
        // });
        // });
        // });
