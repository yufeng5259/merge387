...
@ccclass('RaidKingExtra')
export class RaidKingExtra extends Component {
    @property(Label)
    ...
    Show (centerWindow: any, activityMeta: any) {
        ...
        const currentNeed = Meta.ActivityParamsMeta.GetValue(Meta.ActivityParamsMeta.Types.RaidMaster, currentId);
        const currentGet = Game.Content.FromString(Meta.ActivityParamsMeta.GetValue(Meta.ActivityParamsMeta.Types.RaidMasterReward, currentId));
